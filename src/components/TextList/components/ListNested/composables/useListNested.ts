import type { TextListNestedProps, TextListType, TextListTypeToListItemPrefixComponentMap } from '../../../types';
...
export const useListNested = (
  ...
  const listItemPrefixIconTypes: TextListType[] = ['icon-arrow-single', 'icon-arrow-double', 'icon-checked'];
