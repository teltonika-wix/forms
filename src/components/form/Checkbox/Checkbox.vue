...
<template>
  <div :class="classes.base()">
    <input
      ...
      @change="handleChange"
    />
    <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" :class="classes.svgChecked()">
    ...
    <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" :class="classes.svgUnchecked()">
