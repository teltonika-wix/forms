...
export const togglerStates: Record<TogglerState, string> = /*tw*/ {
  activeEnabled: 'bg-blue-600 hover:bg-blue-700 cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-600',
  inactiveEnabled: 'bg-grey-400 hover:bg-grey-600 cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-600',
