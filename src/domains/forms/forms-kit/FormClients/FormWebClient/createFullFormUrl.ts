...
export type CreateFullFormUrlParams = Pick<FormWebClientParams, 'formWebClientEndpoint' | 'isDev'> & {
  searchParams: ExactFormUrlParameters;
};

export const createFullFormUrl = ({ formWebClientEndpoint, searchParams, isDev }: CreateFullFormUrlParams): string => {
