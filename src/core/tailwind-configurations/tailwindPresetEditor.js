// !IMPORTANT: This file is only used for the editors intellisense. It is not used in the application build process.
// Update this file when updating the tailwindPreset.js file.
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'ttd-gradient': 'linear-gradient(180deg, rgba(17, 23, 41, 0.6) 0%, rgba(32, 41, 58, 0.1) 100%)',
        'dtt-gradient':
          'linear-gradient(180deg, rgba(103, 116, 136, 0) 30%, rgba(17, 23, 41, 0.5) 50%, rgba(17, 23, 41, 0.8) 100%)',
        'dtt-gradient-2': 'linear-gradient(0deg, #111729 0%, rgba(17, 23, 41, 0) 46.35%, rgba(17, 23, 41, 0) 100%)',
